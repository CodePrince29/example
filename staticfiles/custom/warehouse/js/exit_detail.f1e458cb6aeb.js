...
function sum_table(){
  ...
  $("#exit_total_kg").val(result_total_kg.toFixed(2))
  $("#exit_total_price").val(result_price.toFixed(2))
  $("#exit_kg_per_price").val(result_kg_per_price.toFixed(2))
  $("#exit_boxes").val(result_boxes.toFixed(2))
  $("#exit_kg_per_boxes").val(result_kg_per_boxes.toFixed(2))
}
...
function addPallet(total_pallete, selector, position_i) {
        ...
        total_pallete.forEach(function(palet){  
          ...
          per_box =  parseFloat(palet.boxes* per_boxes).toFixed(2)          
