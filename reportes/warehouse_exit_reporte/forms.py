...
class AdvancedFilterFormSet(BaseFormSet):
    ...
    def __init__(self, *args, **kwargs):       
        ...
        [exit_fields.append(("{}".format(field.name), field.verbose_name)) for field in WarehouseExit._meta.get_fields() if not field.is_relation]
        ...
        [measurment_fields.append(("wexitproductmeasurement__{}".format(field.name), field.verbose_name)) for field in WExitProductMeasurement._meta.get_fields() if not field.is_relation]
        [confirmation_fields.append(("wexitconfirmation__{}".format(field.name), field.verbose_name)) for field in WExitConfirmation._meta.get_fields() if not field.is_relation]
        [wincidenceproduct_fields.append(("wexitproductvehicleinspection__{}".format(field.name), field.verbose_name)) for field in WExitProductVehicleInspection._meta.get_fields() if not field.is_relation]
